		...
		SqlMapClientOperations
{
	 ...
	 */
	public LippenSqlMapClientTemplate()
	{
	}
	 ...
	 */
	public LippenSqlMapClientTemplate(SqlMapClient sqlMapClient)
	{
	 ...
	 *            iBATIS SqlMapClient that defines the mapped statements
	 */
	public LippenSqlMapClientTemplate(DataSource dataSource,
	...
	public DataSource getDataSource()
	{
		...
		return (ds != null ? ds : getSqlMapClient().getDataSource());
	}
			...
			throws DataAccessException
	{
		...
		// We always need to use a SqlMapSession, as we need to pass a
		// Spring-managed
		...
		try
		{
			...
			catch (SQLException ex)
			{
				throw getExceptionTranslator().translate(
						"SqlMapClient operation", null, ex);
			}
			finally
			{
				try
		...
		finally
		{
			...
			/**
			 * fixed by EXvision at 2011-07-14
			 */
			if (ibatisCon != null)
			{
				session.close();
